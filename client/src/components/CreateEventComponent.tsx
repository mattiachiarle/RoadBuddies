...
export default function CreateEventComponent() {
    ...
    useEffect(() => {
        const fetchParticipants = async () => {
            ...
            if (error) {
                ...
                const attendees = data.map(participant => ({ email: participant.user_id }));
    ...
    const handleRemoveAttendee = (index) => {
        const newAttendees = eventDetails.attendees.filter((_, idx) => idx !== index);
        setEventDetails({ ...eventDetails, attendees: newAttendees });
    };
    ...
    const handleSubmit = async (e) => {
        ...
        const validAttendees = eventDetails.attendees.filter(attendee => attendee.email.trim() !== "");
